...
class GestionCategoriePage extends StatefulWidget {
  GestionCategoriePage({super.key});

  @override
  State<GestionCategoriePage> createState() => _GestionCategoriePageState();
}

class _GestionCategoriePageState extends State<GestionCategoriePage> {
