...
class OffreBloqueeWebPage extends StatefulWidget {
  OffreBloqueeWebPage({super.key});

  @override
  State<OffreBloqueeWebPage> createState() => _OffreBloqueeWebPageState();
}

class _OffreBloqueeWebPageState extends State<OffreBloqueeWebPage> {
