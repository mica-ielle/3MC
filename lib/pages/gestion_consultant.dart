...
class GestionConsultantPage extends StatefulWidget {
  GestionConsultantPage({super.key});

  @override
  State<GestionConsultantPage> createState() => _GestionConsultantPageState();
}

class _GestionConsultantPageState extends State<GestionConsultantPage> {
  Consultant consultantExemple1 = Consultant(
imageProfil: Image.asset('assets/man.jpeg'), // Remplacez par le chemin de votre image
iconeVerification: Icons.verified, // Icône pour la vérification
iconeDevelopper: CupertinoIcons.chevron_left_slash_chevron_right, // Icône pour le développeur (optionnel)
